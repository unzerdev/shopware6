...
/**
 * This is the controller for the Paylater Direct Debit example.
...
try {
    ...
    /** @var PaylaterDirectDebit $paymentType */
    $paymentType = $unzer->fetchPaymentType($paymentTypeId);

    // A customer with matching addresses is mandatory for Direct Debit payment type
    $address = (new Address())
    ...
    // A Basket is mandatory for Paylater Direct Debit payment type
