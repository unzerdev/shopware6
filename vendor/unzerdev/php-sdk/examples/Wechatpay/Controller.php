<?php
/**
 * This is the controller for the WeChatPay example.
...
try {
    ...
    $charge = $unzer->charge(12.99, 'EUR', $paymentTypeId, RETURN_CONTROLLER_URL);
    ...
    // Redirect to the WeChatPay page of the selected bank
