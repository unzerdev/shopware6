<?php
/**
 * This file provides an example implementation of the PostFinanceEfinance payment type.
 *
...
<script>
    ...
    let postFinanceEfinance = unzerInstance.PostFinanceEFinance();
    ...
    form.addEventListener('submit', function(event) {
        ...
        postFinanceEfinance.createResource()
