<?php
/**
 * This file provides an example implementation of the Giropay payment type.
 *
...
<script>
    ...
    // Create an Giropay instance
    let Giropay = unzerInstance.Giropay();

    // Handling payment form submission
    let form = document.getElementById('payment-form');
    form.addEventListener('submit', function(event) {
        event.preventDefault();
        // Creating a Giropay resource
