<?php
/**
 * This is the controller for the iDeal example.
...
try {
    ...
    $charge   = $unzer->charge(12.99, 'EUR', $paymentTypeId, RETURN_CONTROLLER_URL, $customer);
    ...
    // Redirect to the iDeal page of the selected bank
