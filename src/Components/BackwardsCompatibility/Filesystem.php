...
{
    /**
     * @return bool|null Before Shopware 6.5.0.0, both update and write methods have returned bool, now the write method returns void and the update method doesn't exist anymore.
     */
