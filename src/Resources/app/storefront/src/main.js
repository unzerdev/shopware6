...
window.PluginManager.register(
    'UnzerPaymentIdeal',
    UnzerPaymentIdealPlugin,
    '[data-unzer-payment-ideal]'
);
window.PluginManager.register(
    'UnzerPaymentInvoice',
    UnzerPaymentInvoicePlugin,
    '[data-unzer-payment-invoice]'
);
window.PluginManager.register(
    'UnzerPaymentInvoiceSecured',
    UnzerPaymentInvoiceSecuredPlugin,
    '[data-unzer-payment-invoice-secured]'
);
window.PluginManager.register(
    'UnzerPaymentInstallmentSecured',
    UnzerPaymentInstallmentSecuredPlugin,
    '[data-unzer-payment-installment-secured]'
);
window.PluginManager.register(
    'UnzerPaymentPayPal',
...
window.PluginManager.register(
    'UnzerPaymentSepaDirectDebitSecured',
    UnzerPaymentSepaDirectDebitSecuredPlugin,
    '[data-unzer-payment-sepa-direct-debit-secured]'
);
window.PluginManager.register(
