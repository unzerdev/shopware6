...
export default class UnzerPaymentInstallmentSecuredPlugin extends Plugin {
    static options = {
        ...
        installmentsInterestValueElementId:
            'unzer-payment-installments-interest',
    ...
    init() {
        ...
        this.installmentSecured =
            this._unzerPaymentPlugin.unzerInstance.InstallmentSecured();
    ...
    _registerEvents() {
        ...
        this.installmentSecured.addEventListener(
            'installmentSecuredEvent',
    ...
    _onChangeInstallmentSecuredForm(event) {
        ...
        if (event.currentStep === 'plan-detail') {
            const installmentAmountTotalElement = document.getElementById(
                this.options.installmentsTotalValueElementId
            );
            const installmentInterestElement = document.getElementById(
                this.options.installmentsInterestValueElementId
            );

            installmentAmountTotalElement.innerText =
                this._formatCurrency(
                    this.installmentSecured.selectedInstallmentPlan.totalAmount
                ) + this.options.starSymbol;
            installmentInterestElement.innerText =
                this._formatCurrency(
                    this.installmentSecured.selectedInstallmentPlan
                        .totalInterestAmount
                ) + this.options.starSymbol;
        }
    }
