...
export default class UnzerPaymentUnzerInvoicePlugin extends Plugin {
    static options = {
        isB2BCustomer: false,
        customerInfo: null
    };
    ...
    init() {
        ...
        this.unzerInvoice = this._unzerPaymentPlugin.unzerInstance.PaylaterInvoice();
    ...
    _onCreateResource() {
        ...
        if (this.options.isB2BCustomer) {
            ...
            this.unzerInvoice.createResource()
